  ...
  const renderSearchResult = (result: SearchResult, index: number) => {
    return (
      <div key={`${result.title}-${index}`} className="mb-6">
        ...
        <h3 className="text-google-link text-base font-normal leading-tight mb-1">
    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="sticky top-0 z-10 bg-white border-b shadow-sm">
        <div className="flex items-center px-3 py-2 gap-2">
          ...
          <div className="flex-1 bg-google-gray rounded-full px-3 py-2 flex items-center text-sm relative">
            {searchImage.preview ? (
        ...
        <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
          <div className="overflow-x-auto scrollbar-hide">
            <TabsList className="bg-white border-b w-full h-10 justify-start pl-2">
              <TabsTrigger 
                value="all" 
                className="px-3 h-10 data-[state=active]:border-b-[3px] data-[state=active]:border-google-blue data-[state=active]:text-google-blue font-normal data-[state=active]:font-medium rounded-none data-[state=active]:shadow-none text-sm"
              >
                All
              </TabsTrigger>
              <TabsTrigger 
              ...
              <TabsTrigger 
                value="shopping" 
                className="px-3 h-10 data-[state=active]:border-b-[3px] data-[state=active]:border-google-blue data-[state=active]:text-google-blue font-normal data-[state=active]:font-medium rounded-none data-[state=active]:shadow-none text-sm mr-2"
              >
                Shopping
              </TabsTrigger>
            </TabsList>
          ...
          {/* Search Tools */}
          <div className="px-3 py-2 text-xs text-[#70757a] flex justify-between items-center border-b">
          ...
          <div className="pb-20">
            <TabsContent value="all" className="m-0 mt-2">
              ...
              {results.answer && (
                <div className="mx-3 mb-4 p-3 bg-[#f8f9fa] rounded-lg border border-[#dadce0]">
                ...
                <div className="px-3 mb-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {results.relatedSearches.map((item: string, index: number) => (
                      <span 
                        key={index}
                        className="bg-[#f1f3f4] rounded-full px-3 py-1.5 text-sm text-[#3c4043]"
                      >
                        {item}
                      </span>
                    ))}
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {visualMatches.slice(0, 6).map((item: any) => (
                      <div key={item.id} className="rounded-lg overflow-hidden">
                        <div className="bg-gray-50 h-24 overflow-hidden">
                          <img 
                            src={item.imageUrl} 
                            alt={item.title} 
                  ...
                  <PaginationContent>
                    <div className="flex flex-col items-center w-full">
                      <div className="flex justify-center mb-4 items-center">
                        <svg className="h-16 w-16" viewBox="0 0 160 56" focusable="false">
                      ...
                      <div className="flex items-center gap-1 text-sm">
                        <span className="text-google-blue font-medium px-2">1</span>
                        <PaginationItem>
                          <PaginationLink href="#" className="text-[#4285f4] border-0 hover:underline px-2">2</PaginationLink>
                        </PaginationItem>
                        <PaginationItem>
                          <PaginationLink href="#" className="text-[#4285f4] border-0 hover:underline px-2">3</PaginationLink>
                        </PaginationItem>
                        <PaginationItem>
                          <PaginationLink href="#" className="text-[#4285f4] border-0 hover:underline px-2">4</PaginationLink>
                        </PaginationItem>
                        <PaginationItem>
                          <PaginationLink href="#" className="text-[#4285f4] border-0 hover:underline px-2">5</PaginationLink>
                        </PaginationItem>
              ...
              <div className="flex items-center justify-center my-4 px-3">
                <img src="public/lovable-uploads/6df9cb62-5957-471a-a4cd-03bc0e0fbb49.png" alt="Google Logo" className="h-6" />
              </div>
            </TabsContent>

            <TabsContent value="images" className="m-0">
              <div className="px-3 py-4 grid grid-cols-2 gap-2">
        ...
        {/* Bottom Navigation */}
        <div className="fixed bottom-0 left-0 right-0 bg-white pt-2 pb-1 px-6 border-t flex justify-around z-10 max-w-md mx-auto">
